...
class NoiseGenerator : BasePlugin {
  ...
  double last_sineWaveAttack_ = -1.0;
  double last_sineWaveDecay_ = -1.0;
  double last_sineWaveSustain_ = -1.0;
  double last_sineWaveRelease_ = -1.0;
  double last_sineWaveMix_ = -1.0;
  double last_squareWaveType_ = -1.0;
  double last_squareWavePwm_ = -1.0;
  double last_squareWaveAttack_ = -1.0;
  double last_squareWaveDecay_ = -1.0;
  double last_squareWaveSustain_ = -1.0;
  double last_squareWaveRelease_ = -1.0;
  double last_squareWaveMix_ = -1.0;
  double last_sawWaveType_ = -1.0;
  double last_sawWaveAttack_ = -1.0;
  double last_sawWaveDecay_ = -1.0;
  double last_sawWaveSustain_ = -1.0;
  double last_sawWaveRelease_ = -1.0;
  double last_sawWaveMix_ = -1.0;
  double last_triangleWaveType_ = -1.0;
  double last_triangleWaveAttack_ = -1.0;
  double last_triangleWaveDecay_ = -1.0;
  double last_triangleWaveSustain_ = -1.0;
  double last_triangleWaveRelease_ = -1.0;
  double last_triangleWaveMix_ = -1.0;
  double last_whiteNoiseType_ = -1.0;
  double last_whiteNoiseAttack_ = -1.0;
  double last_whiteNoiseDecay_ = -1.0;
  double last_whiteNoiseSustain_ = -1.0;
  double last_whiteNoiseRelease_ = -1.0;
  double last_whiteNoiseMix_ = -1.0;
  double last_pinkNoiseType_ = -1.0;
  double last_pinkNoiseVossMcCartneyNumber_ = -1.0;
  double last_pinkNoiseAttack_ = -1.0;
  double last_pinkNoiseDecay_ = -1.0;
  double last_pinkNoiseSustain_ = -1.0;
  double last_pinkNoiseRelease_ = -1.0;
  double last_pinkNoiseMix_ = -1.0;
  double last_redNoiseType_ = -1.0;
  double last_redNoiseAttack_ = -1.0;
  double last_redNoiseDecay_ = -1.0;
  double last_redNoiseSustain_ = -1.0;
  double last_redNoiseRelease_ = -1.0;
  double last_redNoiseMix_ = -1.0;
  double last_blueNoiseType_ = -1.0;
  double last_blueNoiseAttack_ = -1.0;
  double last_blueNoiseDecay_ = -1.0;
  double last_blueNoiseSustain_ = -1.0;
  double last_blueNoiseRelease_ = -1.0;
  double last_blueNoiseMix_ = -1.0;
  double last_violetNoiseType_ = -1.0;
  double last_violetNoiseAttack_ = -1.0;
  double last_violetNoiseDecay_ = -1.0;
  double last_violetNoiseSustain_ = -1.0;
  double last_violetNoiseRelease_ = -1.0;
  double last_violetNoiseMix_ = -1.0;
  double last_greyNoiseType_ = -1.0;
  double last_greyNoiseAttack_ = -1.0;
  double last_greyNoiseDecay_ = -1.0;
  double last_greyNoiseSustain_ = -1.0;
  double last_greyNoiseRelease_ = -1.0;
  double last_greyNoiseMix_ = -1.0;
  double last_velvetNoiseType_ = -1.0;
  double last_velvetNoiseAttack_ = -1.0;
  double last_velvetNoiseDecay_ = -1.0;
  double last_velvetNoiseSustain_ = -1.0;
  double last_velvetNoiseRelease_ = -1.0;
