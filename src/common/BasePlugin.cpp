...
void BasePlugin::init_logger( void ) {
  PLUGIN_LOG_TRACE( host_, host_log_, "[{:s}] [{:p}] enter()", __FUNCTION__, static_cast< void* >( this ) );
  logger_ = ClapGlobals::PLUGIN_LOGGER->clone( "BasePlugin" );
}
...
bool BasePlugin::init( void ) {
  ...
  PLUGIN_LOG_TRACE( host_,
                 host_log_,
                 "[{:s}] [{:p}] ClapGlobals::PLUGIN_PATH={:?}",
                 __FUNCTION__,
                 static_cast< void* >( this ),
                 ClapGlobals::PLUGIN_PATH.string() );
  PLUGIN_LOG_TRACE( host_, host_log_, "[{:s}] [{:p}] host={:p}", __FUNCTION__, static_cast< void* >( this ), static_cast< void const* >( host_ ) );
  PLUGIN_LOG_TRACE( host_,
                 host_log_,
  ...
  PLUGIN_LOG_TRACE( host_, host_log_, "[{:s}] [{:p}] host_gui={:p}", __FUNCTION__, static_cast< void* >( this ), static_cast< void const* >( host_gui_ ) );
  PLUGIN_LOG_TRACE( host_, host_log_, "[{:s}] [{:p}] host_latency={:p}", __FUNCTION__, static_cast< void* >( this ), static_cast< void const* >( host_latency_ ) );
  PLUGIN_LOG_TRACE( host_, host_log_, "[{:s}] [{:p}] host_log={:p}", __FUNCTION__, static_cast< void* >( this ), static_cast< void const* >( host_log_ ) );
  PLUGIN_LOG_TRACE( host_,
                 host_log_,
  ...
  PLUGIN_LOG_TRACE( host_, host_log_, "[{:s}] [{:p}] host_params={:p}", __FUNCTION__, static_cast< void* >( this ), static_cast< void const* >( host_params_ ) );
  PLUGIN_LOG_TRACE( host_,
                 host_log_,
  ...
  PLUGIN_LOG_TRACE( host_, host_log_, "[{:s}] [{:p}] host_state={:p}", __FUNCTION__, static_cast< void* >( this ), static_cast< void const* >( host_state_ ) );
  PLUGIN_LOG_TRACE( host_,
                 host_log_,
                 "[{:s}] [{:p}] host_surround={:p}",
                 __FUNCTION__,
  ...
  PLUGIN_LOG_TRACE( host_, host_log_, "[{:s}] [{:p}] host_tail={:p}", __FUNCTION__, static_cast< void* >( this ), static_cast< void const* >( host_tail_ ) );
  PLUGIN_LOG_TRACE( host_,
                 host_log_,
...
void const* BasePlugin::get_extension( std::string const& id ) const {
  PLUGIN_LOG_TRACE( host_, host_log_, "[{:s}] [{:p}] enter( id={:?} )", __FUNCTION__, static_cast< void const* >( this ), id );
